...
contract ComplexRewarderPerSec is IComplexRewarder, Ownable, ReentrancyGuard {
    ...
    IMintable public immutable override rewardToken;
    ...
    constructor(IMintable _rewardToken, IFarmDistributor _distributor) {
    ...
    function onCruizeReward(uint256 _pid, address _user, uint256 _amount) external override onlyDistributor {
